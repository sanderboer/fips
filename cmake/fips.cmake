...
macro(fips_setup)
    ...
    set (FIPS_HOST_OSX 0)
    set (FIPS_HOST_MINGW64 0)
    set (FIPS_HOST_LINUX 0)
    
    if (${CMAKE_HOST_SYSTEM_NAME} STREQUAL "MINGW64_NT-10.0")
	set (FIPS_HOST_MINGW64 1)
	message("Host system: MINGW64")
    ...
    elseif (FIPS_HOST_MINGW64)
	    include (${FIPS_ROOT_DIR}/cmake-toolchains/mingw64.cmake)
    else()
